<nav class="bg-white border-gray-200 dark:bg-gray-900">
    <div class="flex flex-wrap justify-between w-full items-center p-4 gap-y-[150px] max-w-full">
        <a href="index.php?page=home" class="flex items-center space-x-4 rtl:space-x-reverse">
            ...
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-[#07B0C1]">Cafetaria <i class="freckle-face-regular">Kribbe</i></span>
        </a>
        <div class="flex items-center space-x-3 rtl:space-x-reverse">
            <p class="self-center text-5xl font-semibold whitespace-nowrap dark:text-[#07B0C1] freckle-face-regular">Krib d'r niet genoeg van!</p>
        </div>
